...
const testimonials = [
  ...
  },
  {
    ...
    source: "TripAdvisor",
    sourceColor: "text-green-500 bg-green-500/10",
    verified: true,
  },
  {
    name: "Ahmad Fauzi",
    ...
    source: "Instagram",
    sourceColor: "text-pink-500 bg-pink-500/10",
    verified: false,
  },
  {
    name: "Dewi Kartika",
            ...
            {testimonials.map((t, i) => (
              <div key={t.name}
                ...
                <div className="flex items-center justify-between">
                  ...
                  <span className={`text-xs font-bold px-2 py-0.5 rounded-full ${t.sourceColor}`}>
                    {t.source}
                  </span>
                </div>
      ...
      <section id="contact" className="py-24 bg-base-200 relative overflow-hidden">
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 relative">
          ...
          <div className="anim-fade-up delay-100 mb-8 bg-[#25D366] rounded-2xl p-5 sm:p-6
            ...
            <a href={`https://wa.me/${WA_NUMBER}?text=${encodeURIComponent("Halo Pesisir Seafood! Saya ingin reservasi meja 🦞")}`}
          ...
          <div className="grid md:grid-cols-2 gap-6 sm:gap-8">
            ...
            <div className="anim-slide-r space-y-5">
              ...
              {/* Google Maps embed */}
              <div className="rounded-2xl border border-base-300 overflow-hidden hover:border-primary/50 transition-colors" style={{height:"220px"}}>
                <iframe
            ...
            {/* Form — no extra space below button */}
            <div className="anim-fade-up delay-200 bg-base-100 rounded-2xl border border-base-300 p-5 sm:p-6 self-start">
              <h3 className="font-black text-xl sm:text-2xl text-base-content mb-5">Kirim Pesan</h3>
                ...
                {[
                  ...
                  <a key={l.label} href={l.href}
                    className="text-base-content/50 hover:text-primary text-sm font-medium
                      transition-all hover:translate-x-1 transform duration-200 inline-block">
                    {l.label}
                  </a>
                ))}
              </div>
