...
export const menuItems: MenuItem[] = [
  { id:1,  name:"Kepiting Saus Padang",   description:"Kepiting segar dimasak saus Padang pedas khas Nusantara, disajikan dengan nasi putih hangat.", price:125000, category:"Kepiting", image:"https://images.unsplash.com/photo-1559734840-f9509ee5677f?w=400&q=75", badge:"Best Seller" },
  { id:2,  name:"Kepiting Saus Tiram",    description:"Kepiting jumbo dengan saus tiram gurih, bawang putih, dan jahe segar pilihan.", price:135000, category:"Kepiting", image:"https://images.unsplash.com/photo-1583532452513-a002b35cc4d6?w=400&q=75" },
  ...
  { id:6,  name:"Cumi Bakar Bumbu Rujak", description:"Cumi bakar dengan bumbu rujak khas Jawa Timur, pedas segar dan menggugah selera.", price:72000, category:"Cumi", image:"https://images.unsplash.com/photo-1626082927389-6cd097cee1fc?w=400&q=75" },
  ...
  { id:9,  name:"Kerang Hijau Kemangi",   description:"Kerang hijau segar dimasak dengan kemangi, cabai merah, dan bumbu rempah pilihan.", price:55000, category:"Kerang", image:"https://images.unsplash.com/photo-1606850780538-cee72c4a4e3a?w=400&q=75" },
  { id:10, name:"Lobster Bakar Spesial",  description:"Lobster segar utuh dibakar dengan butter garlic dan lemon. Hidangan mewah istimewa.", price:285000, category:"Lobster", image:"https://images.unsplash.com/photo-1610540887229-49e0f89c3a64?w=400&q=75", badge:"Signature" },
